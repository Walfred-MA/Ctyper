...
The third line (score:) reports the percentage of unphased k-mer match concordance for each allele (Note: The difference in 31-mers is about 31 times the sequence edit distance).  
